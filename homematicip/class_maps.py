...
TYPE_GROUP_MAP = {
    ...
    GroupType.AUTO_RELOCK_PROFILE: AutoRelockProfileGroup,
    ...
    GroupType.LOCK_PROFILE: LockProfileGroup,
    GroupType.OPEN_DOOR_NOTIFICATION_RULE_GROUP: OpenDoorNotificationRuleGroup,
